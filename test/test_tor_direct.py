...
from python.twitter_auto_post.proxy_manager import ProxyManager
...
def test_tor_rotation():
    ...
    for i in range(3):
        ...
        # Change Tor IP using the direct method
